    ...
    return (
        <div className="bg-green-100">
            <section className='relative bg-green-100 mb-10'>
                ...
                <div className=" bg-white p-6 h-[120px] relative grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-2 px-auto align-middle justify-center">
                ...
                <div className="w-full h-20 bg-green-100"></div>
            </section>
        </div>
    );
};
